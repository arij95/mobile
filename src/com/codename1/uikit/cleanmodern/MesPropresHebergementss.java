 ...
 * @author asus
 */
public class MesPropresHebergementss extends   BaseForm {
    
    public MesPropresHebergementss(Resources res) {
        ...
        ServiceHebergement ser = new ServiceHebergement();
					ArrayList<Hebergement> Tab = ser.getListHebergement(UserCo.userCo.getId());
  ...
  private void addButton(Resources res,String URLImage, boolean liked, int likeCount, int commentCount,int idHebergement, String title,int id, Hebergement ee,String agg,String a, int b, String c, int d, int f, int j, int h, int i,int g, String t) {
 ...
 TextArea tc = new TextArea(title);
      ...
      // System.out.println("");
       ...
       image.addActionListener(e -> {
                       boolean x ;
			x = Dialog.show("Que voulez vous faire ?","","Modifier","Supprimer");
                        if(x){
                       
                            ServiceHebergement bb =new ServiceHebergement();
                           ArrayList<Hebergement> p= bb.getListHebergement(id);
                           
                           
                         
                      //  bb.setHeberg(a, idHebergement);
                      ee.setIdHebergement(idHebergement);
                      ee.setIdAgence(id);
                      ee.setNomAgence(agg);
                      ee.setType_Hebergement(a);
                      ee.setNom_Hebergement(title);
                      ee.setNombre_etoile(b);
                      ee.setAdresse_Hebergement(c);
                      ee.setNombre_chambre(d);
                      ee.setPrix_single(f);
                      ee.setPrix_double(j);
                      ee.setTaux_demi(h);
                      ...
                      ee.setTel(g);
                      ee.setDescription(t);
                      ee.setImage(URLImage);
                             new ModifHeberg(res,ee,idHebergement).show();

                        }
                        else{
                            			boolean y;
                                                y = Dialog.show("Etes vous sur de supprimer ?","","oui","non");
                                                if(y){
                                                  ServiceHebergement bb =new ServiceHebergement();
                           ArrayList<Hebergement> p= bb.getListHebergement(id);
                           bb.supprimerHebergment(idHebergement);
