 ...
 */
public class AfficheVoyageorganise  extends   BaseForm {
    
    public AfficheVoyageorganise(Resources res) {
        ...
        ServiceVoyageorganise ser = new ServiceVoyageorganise();
					ArrayList<Voyageorganise> Tab = ser.getListVoyageorganise(UserCo.userCo.getId());
  ...
  private void addButton(Resources res,String URLImage, boolean liked, int likeCount, int commentCount,int id,int idagence, Voyageorganise ee,String title,String a, String b, String c, String d, String f, String j, int h, int i) {
       ...
       image.addActionListener(e -> {
			...
			x = Dialog.show("Que voulez vous faire ?","","Modifier","Supprimer");
                        if(x){
                            ...
                            ServiceVoyageorganise bb =new ServiceVoyageorganise();
                           ArrayList<Voyageorganise> p= bb.getListVoyageorganise(id);
                           
                           
                         
                      //  bb.setHeberg(a, idHebergement);
                      ee.setId(id);
                      ee.setId_agence(idagence);
                      ee.setNom_agence(title);
                      ee.setDate_depart(a);
                      ee.setDate_retour(b);
                      ee.setOrigine(c);
                      
                      ee.setPays_destination(d);
                      ee.setVille_destination(f);
                      ee.setHotel(j);
                      ee.setPrix_voyage(h);
                      ee.setNb_places(i);
                     
                      ee.setImage(URLImage);
                             new ModifVoyageorganise(res,ee,id).show();
